            ...
            <div className="flex items-center">
              ...
              <Link to="/">
                <img
                  src={logo}
                  alt="Logo"
                  className="w-14 h-14 rounded-full  hidden md:block md:mr-2"
                />
              </Link>
              <div className="text-white  md:m-0 ml-4 font-custom font-extralight text-lg md:text-3xl">
                Terapias Holísticas DMC
              </div>
            </div>
            <div
              className={`md:flex md:items-center md:space-x-24 mt-4 md:mt-0 ${
